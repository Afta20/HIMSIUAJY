...
export default function Hero() {
  return (
    // 1. Layout Flex Vertical agar rapi & terpusat
    <section className="relative pt-32 pb-10 lg:pt-48 lg:pb-32 overflow-hidden bg-himsi-light min-h-[90vh] flex flex-col items-center justify-center">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <Link href="/events" className="w-full sm:w-auto">
              <button className="w-full bg-himsi-red text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-red-700 transition-all flex items-center justify-center gap-2 shadow-xl shadow-red-200 hover:-translate-y-1">
                Lihat Program Kerja
                <ArrowRight size={20} />
              </button>
            </Link>
            ...
            <Link href="/about-us" className="w-full sm:w-auto">
              <button className="w-full bg-white text-himsi-dark border-2 border-gray-200 px-8 py-4 rounded-full font-bold text-lg hover:border-himsi-yellow hover:text-orange-600 transition-all hover:-translate-y-1">
                Tentang HIMSI
              </button>
            </Link>
          </motion.div>
      ...
      {/* 2. Scroll Down Indicator (FIXED) */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 1, duration: 1 }}
        className="
          /* MOBILE: Relative (Mengalir di bawah tombol, aman gak nabrak) */
          relative mt-12
          
          /* DESKTOP: Absolute (Nempel di bawah layar) */
          lg:absolute lg:bottom-10 lg:mt-0 lg:left-1/2 lg:-translate-x-1/2
          
          /* Styling Umum */
          flex flex-col items-center gap-2 text-gray-400 animate-bounce z-20
        "
      >
